package com.starbucks.sistema.venta.logica.Diseno;
...
public class Movimiento implements MouseMotionListener, MouseListener {
	JComponent target;
	Point start_drag;
	Point start_loc;

	public Movimiento(JComponent target) {
		this.target = target;
	}
