...
public class ThePanel extends JPanel {
	...
	public ThePanel(String name, String imgPath, String Titulo) {
		setBackground(Color.WHITE);
		setLayout(new BorderLayout());

		JButton btnNewButton = new JButton(Titulo);
		btnNewButton.setFont(new Font("Franklin Gothic Medium", Font.PLAIN, 18));
