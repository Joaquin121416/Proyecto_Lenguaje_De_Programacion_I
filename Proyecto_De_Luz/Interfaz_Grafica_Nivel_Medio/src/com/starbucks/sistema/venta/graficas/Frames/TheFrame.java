...
import com.starbucks.sistema.venta.logica.Codigo.SLAnimator;
import com.starbucks.sistema.venta.logica.Codigo.SLConfig;
import com.starbucks.sistema.venta.logica.Codigo.SLKeyframe;
import com.starbucks.sistema.venta.logica.Codigo.SLPanel;
import com.starbucks.sistema.venta.logica.Codigo.SLSide;
...
public class TheFrame extends JFrame {
	...
	public TheFrame(String Cargo, String User) {
		TheFrame.User = User;
		setIconImage(Toolkit.getDefaultToolkit().getImage(TheFrame.class.getResource("/data/icono_logo.png")));
