...
import com.loquesea.hilos.Job;
import com.loquesea.hilos.jcThread;
...
public class Carga extends JDialog {
	...
	public Carga(String Cargo,String User) {
		...
		lblLblimagendecarga.setIcon(new ImageIcon(Carga.class.getResource("/com/loquesea/data/img_cargador.png")));
