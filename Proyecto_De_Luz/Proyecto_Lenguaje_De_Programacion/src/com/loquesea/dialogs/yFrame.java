...
public class yFrame extends JFrame {
	...
	public yFrame() {
			...
			/*	GestionIngresar gi = new GestionIngresar();
				try {
					...
					if (gi.Ingresar(User, Contrasea) == 1) {
						...
						Carga c = new Carga("Administrador","");
						c.setVisible(true);
		...
		btnAtras.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/NEXT.png")));
		...
		btnAdelante.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/BACK.png")));
		...
		lbl_Fondo1.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/fondo1.jpg")));
		lbl_Fondo1.setBounds(0, 195, 1000, 347);
		getContentPane().add(lbl_Fondo1);

		JLabel lbl_Fondo2 = new JLabel("");
		lbl_Fondo2.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/locot.png")));
		lbl_Fondo2.setBounds(1000, 195, 1000, 347);
		getContentPane().add(lbl_Fondo2);

		JLabel lbl_Linea2 = new JLabel("");
		lbl_Linea2.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/paloPublic.png")));
		lbl_Linea2.setBounds(0, 542, 1000, 4);
		getContentPane().add(lbl_Linea2);

		JLabel lbl_Linea1 = new JLabel("");
		lbl_Linea1.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/paloPublic.png")));
		lbl_Linea1.setBounds(0, 187, 1000, 14);
		getContentPane().add(lbl_Linea1);

		JLabel lbl_X = new JLabel("");
		lbl_X.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/icons8_Delete_32px.png")));
		...
		lbl_V.setIcon(new ImageIcon(yFrame.class.getResource("/com/loquesea/imagen/icons8_Expand_Arrow_32px.png")));
