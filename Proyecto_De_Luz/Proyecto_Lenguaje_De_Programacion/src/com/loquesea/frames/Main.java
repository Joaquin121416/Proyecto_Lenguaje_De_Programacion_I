...
public class Main implements ActionListener {
	...
	public static void main(String[] args) {
		...
		lblLblmarco.setIcon(new ImageIcon(Main.class.getResource("/com/loquesea/data/Webp.net-resizeimage (2).png")));
		panel.add(lblLblmarco);

		btnAjustes = new JButton("Ajustes");
		btnAjustes.setIcon(new ImageIcon(Main.class.getResource("/com/loquesea/data/imgIconBorrar.png")));
		panel.add(btnAjustes);

		btnSalir = new JButton("Salir");

		btnSalir.setIcon(new ImageIcon(Main.class.getResource("/com/loquesea/data/imgIconBorrar.png")));
		panel.add(btnSalir);
