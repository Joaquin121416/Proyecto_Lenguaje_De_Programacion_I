...
public class TheFrame extends JFrame {
	...
	private final ThePanel p1 = new ThePanel("1", "src/com/loquesea/data/img1.jpg", "VENTAS");
	private final ThePanel p2 = new ThePanel("2", "src/com/loquesea/data/img2.jpg", "MANTENIMIENTO");
	private final ThePanel p3 = new ThePanel("3", "src/com/loquesea/data/img3.jpg", "SALIR");
	private final ThePanel p4 = new ThePanel("4", "src/com/loquesea/data/img4.jpg", "REPORTES");
	private final ThePanel p5 = new ThePanel("5", "src/com/loquesea/data/img5.jpg", "CONSULTAS");
