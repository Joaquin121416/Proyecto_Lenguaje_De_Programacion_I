...
public class Mantenimiento extends JPanel implements ActionListener {
	...
	public Mantenimiento(Boolean Condicion, Boolean Condicion2) {
		...
		btnAdelante.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/imagen/BACK.png")));
		...
		btnAtras.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/imagen/NEXT.png")));
		btnAtras.setFocusPainted(false);
		btnAtras.setContentAreaFilled(false);
		btnAtras.setBorder(null);
		btnAtras.setBounds(-22, 246, 89, 23);
		add(btnAtras);
		btnModificarProductos.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconUpdate.png")));
		...
		lblImagenModificarProductos
				.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgModificarProducto.png")));
		...
		btnAgregarTrabajador.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconAñadir.png")));
		...
		lblImagenAgregarTrabajador
				.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgAgregarTrabajador.png")));
		...
		btnModificarTrabajador.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconBorrar.png")));
		...
		lblImagenModificarTrabajador
				.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgModificarTrabajador.png")));
		...
		btnAgregarCategoria.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconAñadir.png")));
		...
		lblImagenAgregarCategoria
				.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgAgregarInsumos.png")));
		...
		btnModificarCategoria.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconUpdate.png")));
		...
		lblModificarCategoria.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgModificarInsumos.png")));
		...
		btnAgregarCliente.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconAñadir.png")));
		...
		lblAgregarClientes.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgAgregarTrabajador.png")));
		...
		btnModificarClientes.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconUpdate.png")));
		...
		lblModificarClientes.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgModificarProducto.png")));
		lblModificarClientes.setBounds(566, 327, 165, 165);
		add(lblModificarClientes);
		btnAgregar = new JButton("Agregar Productos");
		btnAgregar.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgIconAñadir.png")));
		...
		lblImagenAgregarProductos
				.setIcon(new ImageIcon(Mantenimiento.class.getResource("/com/loquesea/data/imgAgregarProducto.png")));
